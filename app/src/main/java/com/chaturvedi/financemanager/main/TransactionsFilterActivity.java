...
public class TransactionsFilterActivity extends Activity
{
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		switch (item.getItemId())
		{
			case android.R.id.home:
				NavUtils.navigateUpFromSameTask(TransactionsFilterActivity.this);
				return true;
	...
	{
		DatabaseAdapter databaseAdapter = DatabaseAdapter.getInstance(TransactionsFilterActivity.this);
		LayoutInflater inflater = LayoutInflater.from(TransactionsFilterActivity.this);
		...
		intervalTypesAdapter = new ArrayAdapter<String>(TransactionsFilterActivity.this, android.R.layout.simple_spinner_item, intervalTypes);
		...
		String[] months = {"January", "February", "March", "April", "May", "June", "July", "August", "September", "October",
				"November", "December"};
		monthAdapter = new ArrayAdapter<String>(TransactionsFilterActivity.this, android.R.layout.simple_spinner_item, months);
		...
		yearAdapter = new ArrayAdapter<String>(TransactionsFilterActivity.this, android.R.layout.simple_spinner_item, years);
		...
		fromDateTextView.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				DatePickerDialog fromDatePicker = new DatePickerDialog(TransactionsFilterActivity.this, new DatePickerDialog.OnDateSetListener()
				{
					@Override
		...
		toDateTextView.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View v)
			{
				DatePickerDialog toDatePicker = new DatePickerDialog(TransactionsFilterActivity.this, new DatePickerDialog.OnDateSetListener()
				{
					@Override
					public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth)
					{
