...
public class StartupActivity extends Activity
{
	...
	protected void addBank()
	{
		...
		LinearLayout layout=(LinearLayout)layoutInflater.inflate(R.layout.layout_add_bank, null);
		...
		bankNameFields.get(numBanks-1).setLayoutParams(layoutParams);
		...
		bankBalanceFields.get(numBanks-1).setLayoutParams(layoutParams);
		
		parentLayout.addView(layout, linearLayoutParams.get(numBanks-1));
	}
